...
yaml_dir = "./data/sample"
output_path = "./data/train_dataset_nosession_v2.jsonl"
instruction = "다음 상담 내용을 Heartbeat 포맷으로 요약하세요."

mapping = {}
with open("./data/mapping.csv", "r", encoding="utf-8-sig") as f:
    reader = csv.DictReader(f)
    for row in reader:
        mapping[row["yaml_file"]] = row["source_file"]
